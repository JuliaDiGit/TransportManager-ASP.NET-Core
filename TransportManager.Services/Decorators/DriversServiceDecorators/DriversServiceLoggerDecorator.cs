    ...
    public class DriversServiceLoggerDecorator : IDriversService
    {
        ...
        public async Task<Driver> GetDriverAsync(int id, string userLogin)
        {
            try
            {
                ...
                var driver = await _inner.GetDriverAsync(id, userLogin);
        ...
        public async Task<Driver> DeleteDriverAsync(int id, string userLogin)
        {
            try
            {
                ...
                var driver = await _inner.DeleteDriverAsync(id, userLogin);
        ...
        public async Task<Driver> RemoveDriverAsync(int id, string userLogin)
        {
            try
            {
                ...
                var driver = await _inner.RemoveDriverAsync(id, userLogin);
